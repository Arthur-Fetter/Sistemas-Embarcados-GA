...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, DISPLAY_CE_Pin|DISPLAY_DC_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : B1A8_Pin */
  GPIO_InitStruct.Pin = B1A8_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(B1A8_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : DISPLAY_CE_Pin DISPLAY_DC_Pin */
  GPIO_InitStruct.Pin = DISPLAY_CE_Pin|DISPLAY_DC_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
